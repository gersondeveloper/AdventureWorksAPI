...
using AdventureWorks.API.AdventureWorks.Domain.PurchasingContext.Entities;
using AdventureWorks.API.AdventureWorks.Domain.SalesContext.Entities;
using System;
using System.Collections.Generic;

namespace AdventureWorks.API.AdventureWorks.Domain.HumanResourcesContext.Entities
{
